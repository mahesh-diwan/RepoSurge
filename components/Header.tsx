  ...
  return (
    <section className="px-6 pt-24 pb-12 text-center">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter leading-none text-body mb-4">
          REPOSURGE
        </h1>
        <p className="text-muted text-sm md:text-base leading-relaxed mb-6 max-w-lg mx-auto">
