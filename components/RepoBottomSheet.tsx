          ...
          >
            ...
            <div className="px-5 py-4 space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-midnight border border-border rounded-xl p-3">
                  <p className="text-text-muted text-[10px] uppercase tracking-wider mb-1">Gained</p>
                ...
                <div className="bg-midnight border border-border rounded-xl p-3">
                  <p className="text-text-muted text-[10px] uppercase tracking-wider mb-1">Velocity</p>
              ...
              <div>
                <p className="text-text-muted text-[10px] uppercase tracking-wider mb-2">Trend</p>
                <InteractiveSparkline data={repo.sparkline} width={300} height={60} />
              </div>

              {repo.sparkline.length >= 4 && (
                <div>
                  <p className="text-text-muted text-[10px] uppercase tracking-wider mb-2">Chart</p>
              ...
              {repo.forecast && (
                <div className="bg-midnight border border-border rounded-xl p-3">
                  <p className="text-text-muted text-[10px] uppercase tracking-wider mb-1">Forecast</p>
